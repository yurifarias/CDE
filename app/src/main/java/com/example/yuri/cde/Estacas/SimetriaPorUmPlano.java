...
public class SimetriaPorUmPlano extends MainAuxiliar {
    ...
    public SimetriaPorUmPlano(double diametro, double comprimento, double mElasticidade,
    ...
    public double[][] calcularMovimentoElastico(char caso) {
    ...
    private void subdividirMatrizCompontesEstacas(char caso) {
        ...
        double[][] matriz1 = new double[3][nEstacas];
        double[][] matriz2 = new double[3][nEstacas];
    ...
    /* Método para somar os valores das reações encontradas pelas subdivisões do estaqueamento  */
    private Matrix somarReacoesNormais() {
        ...
        double[][] matriz = new double[nEstacas][1];
