...
public class EstacasVerticais extends MainAuxiliar {
    ...
    public EstacasVerticais(double diametro, double comprimento, double mElasticidade,
                            double fx, double fy, double fz, double fa, double fb, double fc,
                            int nEstacas, double cota, Estaca[] estaqueamento) {

        super(diametro, comprimento, mElasticidade, fx, fy, fz,
                fa, fb, fc, nEstacas, cota, estaqueamento);
    ...
    private void acharNovasCoordenadas() {
        ...
        if ((mS[0][0]*(mS[2][2] - mS[1][1]) + Math.pow(mS[0][1],2) - Math.pow(mS[0][2],2)) == 0) {
